...
INSERT INTO marketplace.flow_template_versions (
      ...
      "edges": [
   {
    ...
    {
      "id": "reactflow__edge-anything_cron_triggerb-example_actiona",
      "source": "anything_cron_trigger",
      "sourceHandle": "b",
    ...
    "actions": [
      ...
      "action_id": "anything_cron_trigger", 
      "plugin_version": "0.1.0",
      "label": "Cron Trigger",
      "description": "Triggers a Flow",
    ...
    },
    {
      ...
      "type": "action",
      "plugin_id": "http",
      "action_id": "example_action_2",
      "plugin_version": "0.1.0",
      "label": "Get Ron Weasley",
      "description": "Fetch Character Details from Database",
      "icon": "<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"24\" height=\"24\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\" stroke-linecap=\"round\" stroke-linejoin=\"round\" class=\"lucide lucide-wand\"><path d=\"M15 4V2\"/><path d=\"M15 16v-2\"/><path d=\"M8 9h2\"/><path d=\"M20 9h2\"/><path d=\"M17.8 11.8 19 13\"/><path d=\"M15 9h.01\"/><path d=\"M17.8 6.2 19 5\"/><path d=\"m3 21 9-9\"/><path d=\"M12.2 6.2 11 5\"/></svg>",
      "variables": {},
      "variables_schema": {},
      "input": {
        "method": "POST",
        "url": "https://hp-api.onrender.com/api/character/c3b1f9a5-b87b-48bf-b00d-95b093ea6390",
        "headers": "",
        "body": ""
      },
      "input_schema": {
    ...
    },
    {
      ...
      "action_id": "other_example_action",
      "plugin_version": "0.1.0",
...
}', true, 'v1', '0c8d9e2f-3d4e-4a6d-9c5b-7d2e0402a7c8', '11111111-1111-1111-1111-111111111111', 'Initial version', 'v1.0', true, now(), now(), '0c8d9e2f-3d4e-4a6d-9c5b-7d2e0402a7c8', '0c8d9e2f-3d4e-4a6d-9c5b-7d2e0402a7c8'),
    (uuid_generate_v4(), 'c9b8d2d5-3b12-4a6d-9eb2-1f6c7409b332', 'Template 1 Version 2', '{
      "edges": [
   {
      "id": "reactflow__edge-example_actionb-example_action_2a",
      "source": "example_action",
...
}', true, 'v2', '0c8d9e2f-3d4e-4a6d-9c5b-7d2e0402a7c8', '11111111-1111-1111-1111-111111111111', 'Added step 1', 'v2.0', false, now(), now(), '0c8d9e2f-3d4e-4a6d-9c5b-7d2e0402a7c8', '0c8d9e2f-3d4e-4a6d-9c5b-7d2e0402a7c8'),
    (uuid_generate_v4(), '7df12345-a5d3-4b13-9e3a-2f5c3e6a7b91', 'Template 2 Version 1', '{
      "edges": [
   {
      "id": "reactflow__edge-example_actionb-example_action_2a",
      "source": "example_action",
...
}', false, 'v1', '5e6f1234-b5d7-4e6b-9d3a-6a2e7c1b2a9f', '22222222-2222-2222-2222-222222222222', 'Initial version', 'v1.0', true, now(), now(), '5e6f1234-b5d7-4e6b-9d3a-6a2e7c1b2a9f', '5e6f1234-b5d7-4e6b-9d3a-6a2e7c1b2a9f'),
    (uuid_generate_v4(), 'c9b8d2d5-3b12-4a6d-9eb2-1f6c7409b332', 'Template 3 Version 1', '{
      "edges": [
   {
      "id": "reactflow__edge-example_actionb-example_action_2a",
      "source": "example_action",
...
}', true, 'v1', '1e4f12a7-3c55-4e6d-9b4d-2a1f0403a2a6', '33333333-3333-3333-3333-333333333333', 'Initial version', 'v1.0', true, now(), now(), '1e4f12a7-3c55-4e6d-9b4d-2a1f0403a2a6', '1e4f12a7-3c55-4e6d-9b4d-2a1f0403a2a6'),
    (uuid_generate_v4(), '7df12345-a5d3-4b13-9e3a-2f5c3e6a7b91', 'Template 4 Version 1', '{
      "edges": [
   {
      "id": "reactflow__edge-example_actionb-example_action_2a",
      "source": "example_action",
...
}', false, 'v1', '3d8b144c-1e9d-4a8c-8234-4e5c9b3d5c2f', '44444444-4444-4444-4444-444444444444', 'Initial version', 'v1.0', true, now(), now(), '3d8b144c-1e9d-4a8c-8234-4e5c9b3d5c2f', '3d8b144c-1e9d-4a8c-8234-4e5c9b3d5c2f'),
    (uuid_generate_v4(), 'c9b8d2d5-3b12-4a6d-9eb2-1f6c7409b332', 'Template 5 Version 1', '{
      "edges": [
   {
      "id": "reactflow__edge-example_actionb-example_action_2a",
      "source": "example_action",
...
}', true, 'v1', '2a7b3d8e-2f3c-4b5d-8e3a-4a7c3e6a7c8d', '55555555-5555-5555-5555-555555555555', 'Initial version', 'v1.0', true, now(), now(), '2a7b3d8e-2f3c-4b5d-8e3a-4a7c3e6a7c8d', '2a7b3d8e-2f3c-4b5d-8e3a-4a7c3e6a7c8d');
...
INSERT INTO anything.flows (
    ...
    ('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'c9b8d2d5-3b12-4a6d-9eb2-1f6c7409b332', 'Input Output flow','Flow with input and output', true, now(), now(), '0c8d9e2f-3d4e-4a6d-9c5b-7d2e0402a7c8', '0c8d9e2f-3d4e-4a6d-9c5b-7d2e0402a7c8'),
    ('eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee', 'c9b8d2d5-3b12-4a6d-9eb2-1f6c7409b332', 'Trigger Flow','Flow with Triggger', true, now(), now(), '0c8d9e2f-3d4e-4a6d-9c5b-7d2e0402a7c8', '0c8d9e2f-3d4e-4a6d-9c5b-7d2e0402a7c8'),
      ...
      "variables_schema": {
        ...
        "properties": {
          "openai_api_key": {
            ...
            "description": "Open AI API Key for the flow",
            "type": "string"
          },
          "prompt": {
            "title": "Prompt",
         ...
         "x-jsf-order": ["openai_api_key", "model", "prompt"],
        "required": ["openai_api_key","model", "prompt"],
        "additionalProperties": false
      },
      "input": {},
      "input_schema": {},
...
INSERT INTO anything.tasks (
    task_id, account_id, task_status, flow_id, flow_version_id, action_label, trigger_id, trigger_session_id, trigger_session_status, flow_session_id, flow_session_status, action_id, type, plugin_id, stage, config, context, started_at, ended_at, debug_result, result, updated_at, created_at, updated_by, created_by
) VALUES
    (uuid_generate_v4(), 'c9b8d2d5-3b12-4a6d-9eb2-1f6c7409b332', 'completed', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', '11111111-1111-1111-1111-111111111111', 'Trigger Action', 'trigger1', 'session1', 'completed', 'flow_session_1', 'completed', 'http_what', 'action', 'extension1', 'DEV', '{"key": "value"}', '{"key": "value"}', now(), now(), '{"key": "value"}', '{"key": "value"}', now(), now(), '0c8d9e2f-3d4e-4a6d-9c5b-7d2e0402a7c8', '0c8d9e2f-3d4e-4a6d-9c5b-7d2e0402a7c8'),
    (uuid_generate_v4(), '7df12345-a5d3-4b13-9e3a-2f5c3e6a7b91', 'completed', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', '22222222-2222-2222-2222-222222222222', 'Trigger Action', 'trigger2', 'session2', 'completed', 'flow_session_2', 'completed', 'derp_action', 'action', 'extension2', 'DEV', '{"key": "value"}', '{"key": "value"}', now(), now(), '{"key": "value"}', '{"key": "value"}', now(), now(), '5e6f1234-b5d7-4e6b-9d3a-6a2e7c1b2a9f', '5e6f1234-b5d7-4e6b-9d3a-6a2e7c1b2a9f'),
    (uuid_generate_v4(), 'c9b8d2d5-3b12-4a6d-9eb2-1f6c7409b332', 'completed', 'cccccccc-cccc-cccc-cccc-cccccccccccc', '33333333-3333-3333-3333-333333333333', 'Trigger Action', 'trigger3', 'session3', 'completed', 'flow_session_3', 'completed', 'my_favorite_action', 'action', 'extension3', 'DEV', '{"key": "value"}', '{"key": "value"}', now(), now(), '{"key": "value"}', '{"key": "value"}', now(), now(), '1e4f12a7-3c55-4e6d-9b4d-2a1f0403a2a6', '1e4f12a7-3c55-4e6d-9b4d-2a1f0403a2a6'); 
...
INSERT INTO marketplace.action_templates (
    action_template_id, account_id, app_action_template_id, publisher_id, slug, type, public, action_template_name, action_template_description, action_template_definition, updated_at, created_at, updated_by, created_by
) VALUES
    (uuid_generate_v4(), 'c9b8d2d5-3b12-4a6d-9eb2-1f6c7409b332', '123e4567-e89b-12d3-a456-426614174004', '0c8d9e2f-3d4e-4a6d-9c5b-7d2e0402a7c8', 'simple_http_action', 'action', true, 'Example Action 1', 'This is the first example action', '{
      "anything_action_version": "0.1.0",
      "type": "action",
      "plugin_id": "example_plugin",
      "action_id": "example_action", 
      "plugin_version": "0.1.0",
      "label": "Example Marketplace Action 1",
      "description": "This is the first example action",
      "icon": "<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 320 320\"><path d=\"m297.06 130.97c7.26-21.79 4.76-45.66-6.85-65.48-17.46-30.4-52.56-46.04-86.84-38.68-15.25-17.18-37.16-26.95-60.13-26.81-35.04-.08-66.13 22.48-76.91 55.82-22.51 4.61-41.94 18.7-53.31 38.67-17.59 30.32-13.58 68.54 9.92 94.54-7.26 21.79-4.76 45.66 6.85 65.48 17.46 30.4 52.56 46.04 86.84 38.68 15.24 17.18 37.16 26.95 60.13 26.8 35.06.09 66.16-22.49 76.94-55.86 22.51-4.61 41.94-18.7 53.31-38.67 17.57-30.32 13.55-68.51-9.94-94.51zm-120.28 168.11c-14.03.02-27.62-4.89-38.39-13.88.49-.26 1.34-.73 1.89-1.07l63.72-36.8c3.26-1.85 5.26-5.32 5.24-9.07v-89.83l26.93 15.55c.29.14.48.42.52.74v74.39c-.04 33.08-26.83 59.9-59.91 59.97zm-128.84-55.03c-7.03-12.14-9.56-26.37-7.15-40.18.47.28 1.3.79 1.89 1.13l63.72 36.8c3.23 1.89 7.23 1.89 10.47 0l77.79-44.92v31.1c.02.32-.13.63-.38.83l-64.41 37.19c-28.69 16.52-65.33 6.7-81.92-21.95zm-16.77-139.09c7-12.16 18.05-21.46 31.21-26.29 0 .55-.03 1.52-.03 2.2v73.61c-.02 3.74 1.98 7.21 5.23 9.06l77.79 44.91-26.93 15.55c-.27.18-.61.21-.91.08l-64.42-37.22c-28.63-16.58-38.45-53.21-21.95-81.89zm221.26 51.49-77.79-44.92 26.93-15.54c.27-.18.61-.21.91-.08l64.42 37.19c28.68 16.57 38.51 53.26 21.94 81.94-7.01 12.14-18.05 21.44-31.2 26.28v-75.81c.03-3.74-1.96-7.2-5.2-9.06zm26.8-40.34c-.47-.29-1.3-.79-1.89-1.13l-63.72-36.8c-3.23-1.89-7.23-1.89-10.47 0l-77.79 44.92v-31.1c-.02-.32.13-.63.38-.83l64.41-37.16c28.69-16.55 65.37-6.7 81.91 22 6.99 12.12 9.52 26.31 7.15 40.1zm-168.51 55.43-26.94-15.55c-.29-.14-.48-.42-.52-.74v-74.39c.02-33.12 26.89-59.96 60.01-59.94 14.01 0 27.57 4.92 38.34 13.88-.49.26-1.33.73-1.89 1.07l-63.72 36.8c-3.26 1.85-5.26 5.31-5.24 9.06l-.04 89.79zm14.63-31.54 34.65-20.01 34.65 20v40.01l-34.65 20-34.65-20z\"/></svg>",
      "variables": {},
      "input": {
