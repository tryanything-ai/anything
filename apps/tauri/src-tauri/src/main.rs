...
fn main() {
    ...
    let dsn: String = "https://039dc60dfff0ff9bad479898055d1d7f@o4505953297498112.ingest.us.sentry.io/4505953410940928".to_string();
    ...
    let runtime_config = RuntimeConfigBuilder::default()
        ...
        .build()
        .unwrap();
    let anything_config = AnythingConfigBuilder::default()
    ...
    tauri::Builder::default()
        ...
        .plugin(
            tauri_plugin_anything::AnythingBuilder::default()
                .config(anything_config)
                .build(),
        )
        // .setup(|app| {
        //     //DEEPLINK
