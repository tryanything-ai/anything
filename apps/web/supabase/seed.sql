...
INSERT INTO anything.flow_versions (
    ...
    "actions": [
        {
            ...
            "node_label": "Llama CLI",
            "node_name": "cli_action_1",
            "presentation": {
                "position": {
                    "x": 190,
                    "y": 430
        ...
        },
        {
            ...
            "node_label": "OpenAI Chat Completion",
            "node_name": "http_action",
            "presentation": {
                "position": {
                    "x": 191.26021505397455,
                    "y": 575.3903225809618
                }
            },
            "trigger": false,
        ...
        },
        {
            ...
            "node_label": "Get price of Bitcoin",
            "node_name": "http_action_1",
            "presentation": {
                "position": {
                    "x": 193.70199949880816,
                    "y": 716.3132988192187
                }
            },
            "trigger": false,
        ...
        },
        {
            ...
            "node_label": "Get price of Ethereum",
            "node_name": "http_action_2",
            "presentation": {
                "position": {
                    "x": 195.93560939352028,
                    "y": 868.1901985346229
                }
            },
            "trigger": false,
    ...
    "edges": [
        {
            "id": "reactflow__edge-cli_action_1b-http_actiona",
            "source": "cli_action_1",
            "sourceHandle": "b",
            "target": "http_action",
            "targetHandle": "a"
        ...
        {
            "id": "reactflow__edge-http_actionb-http_action_1a",
            "source": "http_action",
            "sourceHandle": "b",
            "target": "http_action_1",
            "targetHandle": "a"
        },
        {
            "id": "reactflow__edge-http_action_1b-http_action_2a",
            "source": "http_action_1",
            "sourceHandle": "b",
            "target": "http_action_2",
            "targetHandle": "a"
        },
        {
            "id": "reactflow__edge-cron_triggera-cli_action_1a",
            "source": "cron_trigger",
            "sourceHandle": "a",
            "target": "cli_action_1",
            "targetHandle": "a"
    ...
    "flow_id": "c4c7c81d-4264-4ccf-a569-92445c1d1196",
    "flow_version_id": "f9ffb97f-5b90-45d4-89c5-84045c7b8ca8",
    "latest_version_id": "0.0.1",
    "name": "2 Types of OpenAI Chat",
    "trigger": {
        "anything_trigger_version": "0.0.0",
        "config": {
            "pattern": "0 */5 * * * *"
        },
    ...
    "updated_at": "2024-04-30T01:53:11Z",
    "version": "0.0.1"
    ...
    "active": false,
    "edges": [],
    "flow_id": "a79a8e3a-955d-4d2b-9783-ec51bb3d950a",
    "flow_version_id": "71bb61a1-074a-4127-b8d6-7d4daa011151",
    "latest_version_id": "0.0.1",
    "name": "Flow 5",
    "updated_at": "2024-05-08T21:57:34Z",
    "version": "0.0.1"
}', now(), now(), '1e4f12a7-3c55-4e6d-9b4d-2a1f0403a2a6', '1e4f12a7-3c55-4e6d-9b4d-2a1f0403a2a6'),
    ('44444444-4444-4444-4444-444444444444', '7df12345-a5d3-4b13-9e3a-2f5c3e6a7b91', 'dddddddd-dddd-dddd-dddd-dddddddddddd', 'v1.0', 'Initial version of Flow 4', 'checksum4', true, '{
    "actions": [
        {
            "config": {
                "body": "",
    ...
    "updated_at": "2024-05-08T21:57:34Z",
    "version": "0.0.1"
}', now(), now(), '3d8b144c-1e9d-4a8c-8234-4e5c9b3d5c2f', '3d8b144c-1e9d-4a8c-8234-4e5c9b3d5c2f'),
    ('55555555-5555-5555-5555-555555555555', 'c9b8d2d5-3b12-4a6d-9eb2-1f6c7409b332', 'eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee', 'v1.0', 'Initial version of Flow 5', 'checksum5', true, '{
    "actions": [
        {
            "config": {
                "body": "",
