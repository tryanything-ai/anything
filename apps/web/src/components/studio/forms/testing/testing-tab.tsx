    ...
    return (
        <div className="grid w-full items-start gap-6">
            <div className="w-full">
                ...
                {testing.testFinishedTime ? <span className="m-4 p-2 rounded-lg bg-green-400">Run Time: {formatDuration(intervalToDuration({start: testing.testStartedTime, end: testing.testFinishedTime}))}</span> : null}
